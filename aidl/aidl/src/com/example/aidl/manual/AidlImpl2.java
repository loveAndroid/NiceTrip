...
public abstract class AidlImpl2 extends Binder implements AidlInterface {
	...
	public static AidlInterface asInterface(IBinder obj) {
		...
		if (((iin != null) && (iin instanceof AidlImpl2))) {
			return ((AidlImpl2) iin);
		}
		return new AidlImpl2.Proxy(obj);
	}
